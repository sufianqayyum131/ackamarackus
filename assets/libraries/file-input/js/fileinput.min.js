...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="fa fa-file fa-fw"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadRetryIcon: '<i class="fa fa-repeat fa-fw"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fa fa-download fa-fw"></i>',
                    downloadClass: 'btn btn-kv btn-default btn-outline-secondary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fa fa-search-plus fa-2x fa-fw"></i>',
                    zoomClass: 'btn btn-kv btn-default btn-outline-secondary',
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="f afa-arrows-alt fa-fw"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="fa fa-plus-circle text-warning"></i>',
                    indicatorSuccess: '<i class="fa fa-check-square fa-fw text-success"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa fa-arrows-v fa-fw"></i>',
            fullscreen: '<i class="fa fa-arrows-alt fa-fw"></i>',
            borderless: '<i class="fa fa-expand fa-fw"></i>',
            close: '<i class="fa fa-close fa-fw"></i>'
        },
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="fa fa-file fa-fw"></i>',
        ...
        cancelIcon: '<i class="f afa-ban fa-fw"></i>',
        ...
        msgValidationErrorIcon: '<i class="fa fa-exclamation-circle fa-fw"></i> ',
